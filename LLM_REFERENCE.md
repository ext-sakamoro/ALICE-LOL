...
This compiles to an `SdfNode` tree that can be evaluated on CPU (SIMD 8-wide), transpiled to GLSL/WGSL/HLSL shaders, or meshed via Marching Cubes.
...
## Complete Syntax Reference (76 constructs)
